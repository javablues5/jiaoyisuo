...
@Component
@Slf4j
@ServerEndpoint("/webSocket/ld/{userId}")
public class WebSocketLeiDa {

    /**静态变量，用来记录当前在线连接数。应该把它设计成线程安全的。*/
    private static int onlineCount = 0;
    /**concurrent包的线程安全Set，用来存放每个客户端对应的WebSocket对象。*/
    public static ConcurrentHashMap<String, WebSocketLeiDa> webSocketMap = new ConcurrentHashMap<>();
    ...
    public void onOpen(Session session, @PathParam("userId") String userId) {
        ...
        this.userId=userId;
        //redisCache.setCacheObject(this.userId,"1");
        ...
        log.debug("用户连接:"+this.userId+",当前在线人数为:" + getOnlineCount());
